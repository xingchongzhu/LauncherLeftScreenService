...
package com.royole.appservice.anim;
...
public class Interpolators {
    ...
    public static final Interpolator HOME_PAGE_SCROLL = new PathInterpolator(0.2f, 0f, 0.1f, 1f);
    public static final Interpolator EXAGGERATED_EASE;
    public static final Interpolator UPSCROLL_DISMISS = new PathInterpolator(0.2f, 0.0f, 1f, 1f);
    public static final Interpolator ACCEL_DISMISS = new PathInterpolator(0.4f, 0.0f, 1f, 1f);
    ...
    public static Interpolator mapToProgress(Interpolator interpolator, float lowerBound,
            float upperBound) {
        return t -> Utilties.mapRange(interpolator.getInterpolation(t), lowerBound, upperBound);
    }
}
